...
export default PageCrearUsuario;

/*<div className="container-fluid w-100">
      <div className="d-flex align-items-center w-100 gap-3 p-3">
        <LabelNinfo title="Email" />
      ...
      <div className="d-flex align-items-center w-60  p-3">
        <div className="p-2">
          <LabelNinfo title="Confirmar" />
      ...
      <div className="d-flex align-items-center w-60  p-3">
        <div className="p-2">
          <LabelNinfo title="Fecha de" />
          <div className="col-md-3">
            <LabelNinfo title="Nacimiento" />
          </div>
        </div>
        <input
          type="text"
