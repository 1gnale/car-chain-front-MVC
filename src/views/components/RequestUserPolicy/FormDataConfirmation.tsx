            ...
            <div className="mb-5">
              <div className="d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <p className="text-info-emphasis mb-0">Revisa toda la información antes de continuar</p>
                </div>
              </div>
            </div>
            ...
            <div className="card bg-dark border-info mb-4" style={{ borderRadius: '16px', border: '1px solid rgba(13, 202, 240, 0.3)' }}>
              ...
              <div className="card-body p-4">
                <div className="row g-4">
                  ...
                  <div className="col-md-3">
                    <div className="mb-3">
                      <label className="form-label text-info fw-bold small">Teléfono</label>
                      <div className="text-light fw-normal">
            ...
            <div className="card bg-dark border-info mb-4" style={{ borderRadius: '16px', border: '1px solid rgba(13, 202, 240, 0.3)' }}>
              ...
              <div className="card-body p-4">
                <div className="row g-4">
                  <div className="col-md-3">
                    <div className="mb-3">
                      <label className="form-label text-info fw-bold small">Matrícula</label>
                      <div className="text-light fw-normal">
                  ...
                  <div className="col-md-3">
                    <div className="mb-3">
                      ...
                      <div className="text-light fw-normal">
                        {policy.lineaContizacion?.cotizacion?.vehiculo?.gnc ? "Sí" : "No"}
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3">
                  ...
                  <div className="col-md-3">
                    <div className="mb-3">
                      <label className="form-label text-info fw-bold small">Versión</label>
                      <div className="text-light fw-normal">
                  ...
                  <div className="col-md-3">
                    <div className="mb-3">
                      <label className="form-label text-info fw-bold small">Año</label>
                      <div className="text-light fw-normal">
                        {policy.lineaContizacion?.cotizacion?.vehiculo?.añoFabricacion || 'No especificado'}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="card-body p-4">
                <div className="row g-4">
                  {[
                    ...
                    { key: 'cedulaVerde', title: 'Cédula Verde', icon: 'fas fa-id-card' }
                  ].map((item, index) => (
