...
const FormDataClient = ({
  handleCurrentView, userMail
}: {
  handleCurrentView: (pass: boolean, hardValue?: number) => void; userMail: string | null
}) => {
  // States MODELO DATOS
  ...
  const clientAuth = async () => {
    const clienteRepository = new ClienteRepository(
      `${import.meta.env.VITE_BASEURL}/api/clientes/get-cliente-by-email/${userMail}`
    );
    try {
